            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-primary font-weight-bold">Válida tus certificados</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Capacitate en BIARI y obtén certificados que respalden tus conocimientos</p>
                        <a class="btn btn-primary btn-xl" href="{{route('certificado')}}">Por cod. certificado</a>
                        <a class="btn btn-primary btn-xl" href="{{route('documento')}}">Por doc. identidad</a>
                    </div>
                </div>
            </div>
        </header>
