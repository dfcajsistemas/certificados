            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h2 class="mt-0">Verificar certificado</h2>
                        <hr class="divider" />
                        <p class="text-muted mb-5">Ingresa el código.</p>
                    </div>
                </div>
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        <form action="{{route('certificado')}}" method="GET">
                            @csrf
                            <!-- Name input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="codigo" name="codigo" type="text" placeholder="Ingresar el código..."/>
                                <label for="codigo">Código</label>
                            </div>
                            <!-- Submit Button-->
                            <div class="d-grid"><button class="btn btn-primary btn-xl" id="submitButton" type="submit"><i class="bi-search"></i> Buscar</button></div>
                        </form>
