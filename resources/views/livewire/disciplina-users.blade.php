<div class="card card-outline card-navy">
    <div class="card-header">
        <h3 class="card-title text-muted"><i class="fa-solid fa-angle-right text-orange"></i> Usuarios</h3>
    </div>
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-2">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" onclick="celiminar('{{$user->name}}', {{$user->id}})" class="btn btn-outline-danger btn-xs" title="Eliminar"><i class="fa-solid fa-trash-can"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
