@props(['idModal'=>'modal', 'largo'=>'', 'mtitulo'=>'', 'metodo'=>''])
    ...
    <div class="modal-dialog {{$largo}}">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button type="button" wire:click.prevent="{{$metodo}}()" wire:loading.attr="disabled" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Guardar</button>
        </div>
      </div>
    </div>
</div>
